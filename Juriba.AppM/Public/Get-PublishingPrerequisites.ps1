function Get-PublishingPrerequisites {
    <#
      .SYNOPSIS
      ...
      .EXAMPLE
      Get-PublishingPrerequisites -Authorization "GdyisqPgfd+KqJp6nS3PV3gggM+dh57jHWctzAzj/nDfxWZ7+g0CnvA==" -Instance "appm.demo.juriba.com" -IntegrationId 1 -PublishingId 2
