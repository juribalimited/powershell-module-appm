function Get-PublishingProperties {
    <#
      .SYNOPSIS
      ...
      .EXAMPLE
      Get-PublishingProperties -Authorization "GdyisqPgfd+KqJp6nS3PV3gggM+dh57jHWctzAzj/nDfxWZ7+g0CnvA==" -Instance "appm.demo.juriba.com" -IntegrationId 1 -PublishingId 2
